...
async function fetchLabFusionMatrixData(idx) {
  ...
  try {
    state.labFusionMatrixDataMap[idx] = await fetchJSON("/static/data/lab/lab_backtest_fusion_" + idx + ".json");
  } catch (e) {
...
async function fetchLabRetestHonors() {
  ...
  try {
    state.labRetestHonors = await fetchJSON("/static/data/lab/lab_retest_honors.json");
  } catch (e) {
...
async function fetchLabAblationData() {
  ...
  try { state.labAblationData = await fetchJSON("/static/data/lab_ablation.json"); }
...
async function fetchLabSymmetryData() {
  ...
  try { state.labSymmetryData = await fetchJSON("/static/data/lab_short_symmetry.json"); }
...
async function fetchLabParamScanData() {
  ...
  try { state.labParamScanData = await fetchJSON("/static/data/lab_param_scan.json"); }

...
| 2026-09-01 | 0.8196 | 28,636,470 | ? | 37fe7855a docs(governance): 开源/方法论评估必须跨角色穷举(§5.1补强,ponytail+Karpathy两次同病根治); e7f789c2a docs(规范): 落档「外部系统先查社区」教训(L47)——§5.1强化触发词+§18①通用共享表加行+archive原文+memory(2026-09-01 用户批评闭门造车) |
...
| 2026-09-01 | ? | 37fe7855a docs(governance): 开源/方法论评估必须跨角色穷举(§5.1补强,ponytail+Karpathy两次同病根治); e7f789c2a docs(规范): 落档「外部系统先查社区」教训(L47)——§5.1强化触发词+§18①通用共享表加行+archive原文+memory(2026-09-01 用户批评闭门造车) |

...
- 🔹 **长线三玩法 G/H/I（仓位管理 · 真实权威数，2026-08-30 用户三连拍板）** — 凯利长线卖出模式配套仓位管理三档：**G=P≤3d@10万（先卖≤3天年轻仓）收 157.74%/+157,743/强平420笔**、**H=满仓不买@5万 收 230.31%/+115,157/无强平【全场主推】**（两条硬道理：收益率 230.31% 全场最高且无强平=完全确定；操作最简单=满仓不买、无强平规则实盘执行不混乱）、**I=P≤3d@9万 收 156.21%/+140,585/强平392笔**；2026-08-30 起统一「真实权威数」口径——强平日按主库 etf_daily.accum_nav 真实净值价重算（弃旧 b0=0利/b1=线性双估算，旧「唯一16/16年全正」作废，G/I/H 各 4 个负年 2011/2013/2021/2023 等如实披露）；⚠P3d（G/I）红色警示——结果稳定性存疑（同池扫描 3万档强平 +20,285 盈 → 10万档 -31,547 亏，同方法不同资金量结果不一致）+实操性差（需严格执行先卖年轻仓规则易执行偏差），保为可选档不主推，全站公示+卡面角标同步提示；数据与论证见 [`docs/kelly/position/kelly-ghi-real-price-rebase.md`](docs/kelly/position/kelly-ghi-real-price-rebase.md)、[`docs/kelly/position/kelly-ghi-avsp-method-sweep.md`](docs/kelly/position/kelly-ghi-avsp-method-sweep.md)

...
echo "退出码汇总: sim=$RC1 fusion=$RC2 matrix=$RC3 fusion_matrix=$RC4 retest=$RC5 honors=$RC_HONORS backtest=$RC6 abl=$RC_ABL cc=$RC_CC ps=$RC_PS ss=$RC_SS tsj=$RC_TSJ r2=$R2_RC tradesim_r2=$R2_TSJ_RC lab_r2=$LAB_R2_RC git_tl=$GIT_DEPLOY_RC" | tee -a "$LOG"

...
for _pf in summary holdings industry top20 asset_alloc industry_fund_map manuf_subind_fund_map position_backtest holding_concentration_ts scale_change_ts industry_rotation_ts; do

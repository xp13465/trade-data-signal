...
#   SITE_URL=https://s.aisusu.cn/data/overview.json bash scripts/uptime_check.sh  # 自定义 URL
...
#       接 UptimeRobot：dashboard 加 HTTP(s) 监控 -> https://s.aisusu.cn/data/overview.json，
...
URL="${SITE_URL:-https://s.aisusu.cn/data/overview.json}"
DRY_FLAG=""

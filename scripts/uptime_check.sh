...
#   SITE_URL=https://ss.fx8.store/data/overview.json bash scripts/uptime_check.sh  # 自定义 URL
...
#       接 UptimeRobot：dashboard 加 HTTP(s) 监控 -> https://ss.fx8.store/data/overview.json，

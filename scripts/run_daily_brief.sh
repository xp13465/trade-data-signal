...
if ! "$PY" -c "import sys; sys.path.insert(0,'$GIT_REPO'); from app.calendar import is_trading_day; import datetime as _dt; sys.exit(0 if is_trading_day(_dt.date.today()) else 1)"; then

...
**当前规则：买=RSI 事件化（C1 主）+ BB下轨回归辅买点（B1 buy_aux，支持 per-index 增强）+ sw_801110/sw_801140/csi1000/sw_801760/cyb/sw_801150 叠加 RSI上穿40 确认（方案B）+ sw_801030 叠加反弹力度2% 确认（方案A）；卖=20日高回落5%（D1 high-based）∧ close>MA60（S1 多头过滤）∧ DIF<DEA（MACD 死叉确认，s.* 情绪分豁免）**（2026-07-08 方案 B 改，见 §7.4 / §7.7 / §9）

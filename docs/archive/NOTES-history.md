...
> 本文件为 NOTES.md 历史章节归档（§1-§47，2026-07-06 ~ 2026-07-20）。主文件 NOTES.md 只保留头部 + §48 近期章节，减少每次开工读 token。需查历史在此。
...
### 小节A2：2026高位触发偏高的阈值微调评估（2026-07-20，结论=保持72不改）
- **触发**：72阈值2016至今2744交易日触发39次（年化~3.7次，达标3-8），但**2026半年触发15次（年化~30）偏高**，目标3-8次/年。评估是否调高阈值降频。
- **多阈值回测对比**（2016-01~2026-07，约10.5年，低位85不动）：

| 阈值 | 整体触发 | 整体年化 | 2026触发 | 2026年化 | N10胜率 | N20胜率 | N10盈亏比 | 样本外N10 | 训练N10 | 骤降 |
|---|---|---|---|---|---|---|---|---|---|---|
| 72 | 39 | 3.7✓ | 15 | 30✗ | 56.4%✓ | 61.5%✓ | 2.36✓ | 53.8% | 61.5% | -7.7pct✓ |
| 74 | 23 | 2.2✗ | 9 | 18✗ | 52.2%✗ | 60.9%✓ | 3.06✓ | 46.7% | 62.5% | -15.8pct✗ |
| 76 | 11 | 1.0✗ | 4 | 8✓ | 45.5%✗ | 54.5%✗ | 3.28✓ | 37.5% | 66.7% | -29.2pct✗ |
| 78 | 4 | 0.38✗ | 2 | 4✓ | 25%✗ | 50%✗ | 0.00✗ | 33.3% | N/A | 样本太少 |

- **2026触发细分（决策关键）**：72阈值下2026的15次触发**预测力反而更强**——2026 N10下跌胜率60.0%（>整体56.4%>非年54.2%）、N20胜率66.7%（>整体61.5%）、N20盈亏比4.35。明细：2月初4次（冲高后N20转弱）+2月下至3月10次（N10普遍-4%~-6%，**精准预警3月大跌**）+6月1次。即2026高频是市场反复冲高+大跌前密集预警的**正确表现，非误报**。
- **73候选补充**：整体30次（年化2.86<3下限）/2026 12次（年化24仍超）/N10胜率53.3%<72，两头不靠，不可取。
- **决策：保持72不改**。理由：①72整体全达标（年化3.7/N10 56.4%/N20 61.5%/盈亏比2.36/样本外仅降7.7pct/参数相对稳）；②调高74/76/78样本外骤降>10pct（74降15.8/76降29.2）+预测力下滑=**过拟合迹象**（为降2026频率牺牲整体预测力）；③2026高频是有效预警（N10 60%/N20 66.7%>整体），过滤掉反而漏报3月大跌；④针对单一年份调阈本身违反防过拟合原则。
- **代码不动**：alert_score.py/backtest_alert.py 阈值72/85保持。低位85更不动（2026零触发是弱市未到冰点）。后续若2026全年触发仍异常且预测力转弱再评估。

...
| [ai-predict-value-eval-20260906.md](ai-predict-value-eval-20260906.md) | 每日速递 AI 预测价值评估(方向命中 23-33%=无信息基线、区间命中 0/16 系统性全败、flat 失明;结论:砍区间子功能、主推砍整链退化数据摘要、方向题可挂 30 条观察线;对账脚本逐位复核官方 stats) | 2026-09-06 |
...
- [ai-predict-value-eval-20260906/scripts/reconcile_ledger_hits.py](ai-predict-value-eval-20260906/scripts/reconcile_ledger_hits.py) — 每日速递 AI 预测历史命中率独立对账(brief_ledger 14 条 + brief_shadow 8 条 + daily_brief_history 全量 20 条,对 sentinel.db index_daily 逐条算次日涨跌;产出逐条表+三方基线对照;与官方 stats 3/9=33.3% 逐位一致),报告见 [ai-predict-value-eval-20260906.md](ai-predict-value-eval-20260906.md)。

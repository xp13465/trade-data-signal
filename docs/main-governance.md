...
## 18.1 主控专属教训(20 条,2026-08-12 用户定 §18 按归属拆分;2026-08-24 补回填 E25/E26/E27/E29/E30)
> 根 CLAUDE.md §18 索引表中**归属主控**的条目(9 过错 + 11 经验)全文在此。每条一行(锚点|一句话防重犯|归档行号),防重犯原文(含根因+场景+防重犯全文)在 `docs/archive/CLAUDE-errors-2026-08.md` 反追(grep 锚点id)。**命中场景读本清单 → grep 锚点 → 归档原文**。零丢失校验:主控归属 = L01/L15/L17/L20/L21/L23/L24/L26/L28(9)+ E05/E07/E15/E18/E19/E22/E25/E26/E27/E29/E30(11)= 20 条。

...
| [scripts/accum-nav-gap-analysis-20260906.md](scripts/accum-nav-gap-analysis-20260906.md) | **accum_nav 缺价分析**(2026-09-06, 2081 日缺价对 GHI/信号影响=0, 原推荐 B+D) |
| [scripts/accum-nav-refill-feasibility-20260906.md](scripts/accum-nav-refill-feasibility-20260906.md) | **accum_nav 缺价实地重采可补性验证**(2026-09-06, 全量实测 154 只: 82.6% 源有值可零外源回填, 17.4% 源缺=跨境休市/时滞, 建议历史回填一次+告警) |

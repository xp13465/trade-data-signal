...
### 7.1 方案回顾（docs/kelly/analysis/kelly-return-linear-analysis.md §5）
...
组合开启（排除aux + MA60）过滤53%信号（docs/kelly/mining/kelly-loss-reduction-analysis.md §4.3，6152->2908笔）。部分象限（rating_high/sig_backup）样本可能 <100，统计意义弱。卡片已有 n<100 提示（L7496 legend），无需额外处理。
...
- `docs/kelly/mining/kelly-loss-reduction-analysis.md`：21组降亏穷举模拟，最佳组合 MA60+排除aux 减亏64%
- `docs/kelly/analysis/kelly-timing-analysis.md`：MA60大盘择时方案，§5.1 完整 _load_market_state/_is_market_bull 代码
- `docs/kelly/analysis/kelly-return-linear-analysis.md`：A+B+C+D 方案分析，D修正年化语义
- `docs/kelly/analysis/kelly-fee-adjust.md`：费率客调方案A（_kellyRecomputeTrade 重算链）
- `docs/kelly/analysis/kelly-fee-presets.md`：6档费率预设+快捷键

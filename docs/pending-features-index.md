...
| ~~95~~ | ~~ETF→权重龙头个股 回测分支~~ | 2026-08-20 | ~~B1/B2/B3全跑,结论=无实际价值不推荐~~ | 无(已关闭) | **已关闭**(2026-08-21 docs已落 main eee3d9387;A全面优于B1/B2,B3持平但3倍操作量;详见 etf-weight-leader-conclusion.md) |
...
| ~~31~~ | ~~simulate_trade定时调度~~ | — | — | — | **已完成**(update_lab.sh step 11.5已含 `simulate_trade --all`,lab-auto定时链路覆盖) |
| ~~34~~ | ~~场外基金阶段3 场内外联动~~ | — | — | — | **已废弃**(2026-08-21,见 docs/abandoned-features.md) |
...
> 本模块 ~~#34(场外阶段3)~~ 已废弃移入 docs/abandoned-features.md。
...
| ~~84~~ | ~~ETF485全市场扩采集+OHLC~~ | — | — | — | **已完成**(etf_daily已覆盖1530只ETF+OHLC齐全,远超485目标;数据日更新至2026-08-20) |
...
| ~~90~~ | ~~场外基金阶段2 UI / 阶段3 场内外联动~~ | — | — | — | **已废弃**(2026-08-21,#34阶段3已废弃,阶段2 UI 属方案C在 #79;见 docs/abandoned-features.md) |

...
| 68 | **优化批次 E:降亏面板口径标注** | pending #46 | 补「不含仓位控制/峰值持仓991万」口径说明+真实对照行(默认 posK2 上全开=G降23.9万),纯展示文案 §21 公示同步 | **待办**(2026-08-18 建,任务 #23,等 v1.1.2 合完避 lab.js 冲突) |

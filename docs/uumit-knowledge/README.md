...
| C · 指标解读手册 | [`indicator-guide/00-index.md`](indicator-guide/00-index.md) | 成册完成(2026-08-17);**上架受阻(2026-08-18 发布 4 次被平台 4801 内容安全拦截,详见形态 12 与 `uumit-listing-materials.md`),待用户决定**;资产链 `6c688811`(大纲)/`f2ffdfcd`/`d49befab`/`49e2a171`(均未发布);封面 `31d4959ef1234ec1.png` | 10 章三档互证指标字典(指标地图/监控卡/回测/凯利/情绪/宽度资金/信号/ETF评分/口径底线/每日实战),每类指标白话+场景+1:1 真实数字举例,均从站内数据产物核实+复现段;原料 `docs/理财专员使用指南.md` + `docs/explain-1to1-inventory.md`;定价 128 UT(划线 168 UT,用户已确认) |
| C · 指标解读手册交付版 | [`indicator-guide/deliverables/indicator-guide.md`](indicator-guide/deliverables/indicator-guide.md) | 成册交付版完成(2026-08-18,0 触发词);**未发布(4801)** | 对外发布版,去掉内部 `docs/` 路径,保留主站域名引流,`compliance_reword()` 合规措辞;生成脚本 [`indicator-guide/deliverables/scripts/build_indicator_guide_deliverable.py`](indicator-guide/deliverables/scripts/build_indicator_guide_deliverable.py) |

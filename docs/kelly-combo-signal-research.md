...
> 上游：`docs/kelly-loss-mining-v4.md` / `docs/kelly-v4-detail.md` / `docs/kelly-loss-round3-verify.md` / `docs/kelly-backtest-comprehensive-review.md` / `docs/kelly-backtest-deepseek-review.md` / `docs/kelly-backtest-comparison.md` / `docs/kelly-mining-literature.md` / 前端 `static-site/lab.js` L7349-7464（`_kellyPassesFadeFilters`）
...
- 项目内：Lavrac et al. 2002 / Atzmueller 2015 / Bay & Pazzani 2001 / Dong & Li 1999 / Pasquier et al. 1999（见 `docs/kelly-mining-literature.md` 已录）

## 与现有文档的关系
- `docs/kelly-loss-round3-verify.md` — 叠加边际口径、A1/A2/A3 排除依据（本方案 §2 直接复用）
- `docs/kelly-v4-detail.md` / `docs/kelly-loss-mining-v4.md` — 成员指标、过拟合分级、Greedy 组合
- `docs/kelly-backtest-comprehensive-review.md` / `-deepseek-review.md` / `-comparison.md` — 组合推荐、⑦⑧风险、熔断、破坏性 toggle

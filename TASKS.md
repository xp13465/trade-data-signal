...
**最后更新**:2026-09-07 11:2x(v1.1.17 发布链推进中).本轮:**内审+外审全 PASS**(v1.1.16=75532cb32 至今 59 commits,内审 0 FAIL;外审 rev-20260907-001 无 P0/P1);**fix555 + intraday 已 main-merge**(fix555=7071be27b bump a551;intraday=e815e2d36 bump a552),**changelog 补登 a551/a552 完成**(cf7073988);**✅ 模拟回测弹窗改造第一件已上线**:加买入价/卖出价列+删「峰值同时持仓」恒10列移表格上方(feat/sim-price-col→main 367b094e0+1f2c76cdf+b899065a1,bump a553,changelog 补登完成,§0 三查 PASS:线上 index v=20260907-a553+app.min.js 含「持仓中」特征);**v1.1.17 待 deploy+打 tag**(盘中不跑全量 deploy,排盘后避 15:35/16:00/17:50/20:35/22:00 定时时点)。**模拟回测弹窗改造第二件实施中(用户 09-06 拍板)**:①加「次日开盘(默认)/当日收盘」双口径切换开关,与 lab 凯利各自独立影响区域 ②「计划买入时间」列上下换行展示实际买入日期(次日档=下一交易日/当日档=当天) ③第1列「日期」描述完善=信号日期(与计划买入维度不同)(worktree sim-price-toggle/feat/sim-price-toggle base=b899065a1,implementer ac984fb5a 在跑,巡检 cron c3c23c89)。TaskList #69/#70 done、#71 in_progress。前轮 09-06 关键指针保留:#101/#102 已完成上线、#100 sigkelly 渐进加载已上线、FAPI 概念观察期 cron(1e0ef6fb) 09-08 到期。

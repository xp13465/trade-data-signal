...
- **连轴转链**:复权✅ -> T1✅ -> D1✅(a+b,权重TE30/R²25/Dev15/roll15/IR15) -> 信号凯利回测✅(6象限并列3评级+3ETF归类+4模式+3周期) | T9: P0-4✅上线, 剩P2-15(待用户定offshore删vs移R2)/P2-13(CSS will-change)/P2-14(分时SVG)/P2-12(sticky)/P2-10(requestIdleCallback)/P2-11/16重新评估

...
- **邮件其余 section 白话化已派**(ac6cf564b5d415cf8,用户入睡前确认丢连轴):参照 9ce765bef 期货+公募白话化模式,补汪汪队段进/出/量图例+共振白话+净申购白话+每ETF白话+段末结论+主邮件恐贪/均线多空/新高新低/领涨,只改 daily_summary_email.py 模板层不动数据口径
...
- **main HEAD**：512710b12(easytrader submodule)。feat/iframe-theme-follow=main 同步

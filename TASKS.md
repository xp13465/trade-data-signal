...
**待办指针**:#108 四档升级判定源 hs300→cyb 待拍板;v1.1.16..v1.1.18 外审补审(263 commits)待定预算/范围;codex 缓存命中优化(上);`feat/lof-path-absolute-align` 分支 ahead of origin by 2(重复 commit)待 main-merge 收尾。

...
function _renderSigKellyBar(bar, data, period) {
  ...
  const _gihTip =
    ...
    "【源头管位(v2026-08-29)】signal_kelly_trades.json 现由源头回测按 G/H/I 各自仓位法原生管位(与前端 _kellyAihlineApply 同语义 §22), 本页 G/H/I 数据=管位后真实口径, 峰值已≤档位(13/7/16笔, 20倍本金内可操作); 前端再套管位=幂等不变; 非 G/H/I 模式不受影响。\n" +

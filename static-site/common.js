...
function _tdsS06Tooltip() {
  return [
    "【是什么】S06 不是固定勾键组合, 是按大盘风格自动换基座(快照覆盖 2010-02-01 起): 每天收盘算「中证100020日涨幅 − 沪深300 20日涨幅」,",
    "2014-11-13 前中证1000 无数据源, 用同构价差「中证500 20日涨幅 − 沪深300 20日涨幅」代理判定(方案2, 消灭 2011~2014 老信号永久兜底);",

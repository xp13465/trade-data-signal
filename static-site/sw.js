...
const CACHE_VERSION = 'v6-20260813-a186';  // a185->a186(皮肤分支已占a185): 凯利AI降亏过滤区融合(#39/#45) 4大分类组31单标志+组合宏按钮+总开关三级级联, 前端lab.js/lab.css/lab.min重建+bump; a184->a185=皮肤弹窗样式修复; 基底=数字单位a177

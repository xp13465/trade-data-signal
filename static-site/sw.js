...
const CACHE_VERSION = 'v6-20260813-a187';  // a186->a187(ai-advice-rank-fix): 首页AI建议编号改质量序(序号=当日跟踪分降序第N, 与凯利回测K档口径一致, 不随K档跳变) + tooltip/公示同步; a185->a186=凯利AI降亏过滤区融合(#39/#45)+§22 K档口径同步; a184->a185=皮肤弹窗样式修复; 基底=a177
